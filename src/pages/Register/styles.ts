...
export const IconLogin = styled(AiOutlineMail)<PropIcon>`    
    position: absolute;
    font-size: 25px;
    transition: 0.5s;
...
export const Validations = styled.span`    
`;
export const Rules = styled.p` 
    font-size: 1.3rem;
`;
export const Rule = styled.p<PropValidation>`
    padding-left: 0.5rem;
    line-height: 1.1rem;
    ${({test}) => test ? 'color: green' : 'color: red'}; 
`;
